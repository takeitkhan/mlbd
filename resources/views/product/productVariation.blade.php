    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-7">
        ...
        <div class="box box-warning">
            {{-- <div class="box-header">
                ...
                <a href="javascript:void(0)" id="modal_button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#productVariation"  onclick="productVarianteUpdate('store')">
            ...
            <div id="product_added">
                ...
                <tr>
                    <td>{{ $variant->id }}</td>
                    <td >{{ $variant->variationGroup->title }} <input type="hidden" id="variantGroupId{{ $variant->id }}" value="{{ $variant->variation_group_id }}" /></td>
                    <td id="productVariantTitle{{ $variant->id }}">{{ $variant->title }}</td>
                    <td > <input type="hidden" id="productVariantImage{{ $variant->id }}" value="{{ $variant->image_id }}" /> <img src="{{ asset($variant->image->icon_size_directory??'') }}" height="80px" width="100px" alt="{{ __('') }}"> </td>
                    <td id="productVariantActive{{ $variant->id }}">
                        {{ $variant->active }}
                        <input type="hidden" id="dbvariation_product_id{{ $variant->id }}" value="{{ $variant->variation_product_id }}" />
                    </td>
                    <td>
                        <a href="javascript:void(0)"  class="btn btn-xs btn-success" data-toggle="modal" data-target="#productVariation"
        ...
        <form action="{{route('add.product.variation')}}" id="product_variation_form" method="POST">
            <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <button type="button" style="color: #bd0202; margin-left: 1.5rem; outline:none; " class="close pull-left" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            {{ Form::label('variation_group_id', 'Variation Group', array('class' => 'category_id')) }}
                                        ...
                                        <div class="form-group">
                                            <label for="variation_product_id" class="control-label">Variation Product Id</Title></label>
                                            <input  type="text" name="variation_product_id" class="form-control" id="variation_product_id">
                                        </div>

                                        <div class="form-group">
                                            <label for="product_variation_title" class="control-label">Title</Title></label>
                                            <input  type="text" name="product_variation_title" class="form-control" id="product_variation_title">
                                        </div>

                                        <div class="form-group">
                                            <label for="product_variation_image" class="control-label">Image:</label>
                                            <input type="text" name="product_variation_image" class="form-control" id="product_variation_image">
                                        </div>
                                        <div class="form-group">
