...
@csrf
@php
    $getVariations = \App\Models\ProductAttributeVariation::where('main_pid', $prouduct_id)->get();
            ...
            <div class="col-md-3 row_delete"  data-row="{{$row}}">
                ...
                <div class="col-md-12 px-2">
                    <div class="form-group">
                        ...
                        <input required class="form-control input-sm" type="text" name="variation[{{$row}}][sub_title]" id="" value="{{$v->variation_sub_title}}">
                    </div>
                </div>
                <div class="col-md-6 px-2">
                    <div class="form-group">
                        <label for="">Product Code</label>
                        <input required class="form-control input-sm" type="text" name="variation[{{$row}}][product_code]" id="" value="{{$v->variation_product_code}}">
                    </div>
                </div>
                <div class="col-md-6 px-2">
                    <div class="form-group">
                        <label for="">Regular Price</label>
                        <input required class="form-control input-sm" type="number" name="variation[{{$row}}][product_regular_price]" id="" value="{{$v->product_regular_price}}">
                    </div>
                </div>
                ...
                <div class="col-md-6 px-2">
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="number" name="variation[{{$row}}][product_selling_price]" id="" value="{{$v->product_selling_price}}">
                ...
                <div class="col-md-6 px-2">
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="text" name="variation[{{$row}}][variation_image]" id="" value="{{$v->variation_image}}">
...
//                        dd($savedAttrValue[$data->attr_name]);
                    ...
                    <div class="col-md-{{$data->attr_show_as_decision == 'Image' ? '12' : '4'}} px-2">
                        <div class="form-group">
                            ...
                            @if($data->attr_show_as_decision == 'Image')
                                @if($attrImage)
                                    @php
                                        $imgIds = \App\Models\Image::whereIn('id', $attrImage)->get();
                                    @endphp
                                <div class="form-group">
