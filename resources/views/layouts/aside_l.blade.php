    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (Auth::user()->isAdmin() || Auth::user()->isVendor())
                <li
                    class="treeview {{ Request::is('dashboard') || Request::is('most_sold') || Request::is('never_sold') ? 'active menu-open' : '' }}">
                    <a href="">
            ...
            @if (Auth::user()->isAdmin() || Auth::user()->isVendor())
                <li
                    class="treeview {{ Request::is('orders') ||
                    Request::is('orders/prebooking') ||
                    Request::is('search_orders') ||
                    Request::is('orders/placed_cod') ||
                    Request::is('orders/placed') ||
                    Request::is('orders/production') ||
                    Request::is('orders/distribution') ||
                    Request::is('orders/processing') ||
                    Request::is('orders/done') ||
                    Request::is('orders/refund') ||
                    Request::is('orders/cod') ||
                    Request::is('orders/deleted')
                        ? 'active menu-open'
                        : '' }}">
                    <a href="">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ Request::is('orders') || Request::is('search_orders') ? 'active' : '' }}">
                            <a href="#">
                                <i class="fa fa-circle-o"></i> Combo Orders
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('orders/custom-order') || Request::is('orders/custom-order') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/one-click-buy-now') || Request::is('orders/one-click-buy-now') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/date_between') || Request::is('orders/date_between') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/placed_cod') || Request::is('orders/placed_cod') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/placed_opo') || Request::is('orders/placed_opo') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/production') || Request::is('orders/production') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/processing') || Request::is('orders/processing') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/distribution') || Request::is('orders/distribution') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/deleted') || Request::is('orders/deleted') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('orders/temporary') || Request::is('orders/temporary') ? 'active' : '' }}">
            ...
            @if (Auth::user()->isAdmin())
                <li
                    class="treeview {{ Request::is('attributes') || Request::is('add_attributes') || Request::is('add_attributes/{id}') || Request::is('attgroups') || Request::is('add_attgroup') ? 'active menu-open' : '' }}">
                    <a href="">
            ...
            @if (Auth::user()->isAdmin() || Auth::user()->isVendor())
                <li class="treeview {{ Request::is('add_combo_product') ||
                    Request::is('combo_list') || 
                    Request::is('combo_order_list') || 
                    Request::is('combo-product/*')
                        ? 'active menu-open'
                        : '' }}">
                        <a href="">
                            <i class="fa fa-newspaper-o"></i> <span> Combo Products</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="{{ Request::is('add_combo_product') || Request::is('add_combo_product') ? 'active' : '' }}">
                                <a href="{{ url('add_combo_product') }}">
                                    <i class="fa fa-newspaper-o"></i> Add Combo Product
                                </a>
                            </li>
                            <li class="{{ Request::is('combo_list') || Request::is('combo_list') ? 'active' : '' }}">
                                <a href="{{ url('combo_list') }}">
                                    <i class="fa fa-newspaper-o"></i> Combo Products
                                </a>
                            </li>
                            <li class="{{ Request::is('combo_order_list') || Request::is('combo_order_list') ? 'active' : '' }}">
                                <a href="{{ url('combo_order_list') }}">
                                    <i class="fa fa-newspaper-o"></i> Combo Orders
                                </a>
                            </li>
                        </ul>
                </li>
            ...
            @if (Auth::user()->isAdmin() || Auth::user()->isVendor())
                <li
                    class="treeview {{ Request::is('products') ||
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li
                            class="{{ Request::is('import_stock_view') || Request::is('import_stock_view') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('products_express_delivery') || Request::is('products_express_delivery') ? 'active' : '' }}">
                            <a href="{{ url('products_express_delivery') }}">
                                <i class="fa fa-angle-right"></i> Express Delivery
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_enable_comment') || Request::is('products_enable_comment') ? 'active' : '' }}">
                            <a href="{{ url('products_enable_comment') }}">
                                <i class="fa fa-angle-right"></i> Enable Comment
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_enable_review') || Request::is('products_enable_review') ? 'active' : '' }}">
                            <a href="{{ url('products_enable_review') }}">
                                <i class="fa fa-angle-right"></i> Enable Review
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_new_arrival') || Request::is('products_new_arrival') ? 'active' : '' }}">
                            <a href="{{ url('products_new_arrival') }}">
                                <i class="fa fa-angle-right"></i> New Arrival
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_best_selling') || Request::is('products_best_selling') ? 'active' : '' }}">
                            <a href="{{ url('products_best_selling') }}">
                                <i class="fa fa-angle-right"></i> Best Selling
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_recommended') || Request::is('products_recommended') ? 'active' : '' }}">
                        ...
                        <li
                            class="{{ Request::is('admin/variation-group') || Request::is('admin/variation-group') ? 'active' : '' }}">
                            <a href="{{ url('admin/variation-group') }}">
                                <i class="fa fa-angle-right"></i> Variation group
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('products_disable_buy') || Request::is('products_disable_buy') ? 'active' : '' }}">
                        ...
                        @if (Auth::user()->isAdmin())
                            <li
                                class="{{ Request::is('export_products') || Request::is('export_products') ? 'active' : '' }}">
                            ...
                            <li
                                class="{{ Request::is('import_products_view') || Request::is('import_products_view') ? 'active' : '' }}">
                            ...
                            <li
                                class="{{ Request::routeIs('product.attribute.group') || Request::routeIs('product.attribute.group') ? 'active' : '' }}">
            ...
            @if (Auth::user()->isAdmin())
                <li
                    class="treeview {{ Request::is('users') || Request::is('add_user') || Request::is('newsletters') ? 'active menu-open' : '' }}">
                    <a href="">
            ...
            @if (Auth::user()->isAdmin())
                ...
                <li class="treeview {{ Request::is('our_showroom') ? 'active menu-open' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if (Auth::user()->isAdmin())
                            <li
                                class="{{ Request::is('export_showrooms') || Request::is('export_showrooms') ? 'active' : '' }}">
                            ...
                            <li
                                class="{{ Request::is('import_showrooms_view') || Request::is('import_showrooms_view') ? 'active' : '' }}">
            ...
            @if (Auth::user()->isAdmin())
                <li
                    class="treeview {{ Request::is('admin_district*') || Request::is('admin/slider*') || Request::is('admin/catgallary*') || Request::is('commentss') || Request::is('banks') || Request::is('menus') || Request::is('widgets') || Request::is('all_returns') || Request::is('review') ? 'active menu-open' : '' }}">
                    <a href="">
            ...
            @if (Auth::user()->isAdmin() || Auth::user()->isVendor())
                <li
                    class="treeview {{ Request::is('coupons') || Request::is('vouchers') ? 'active menu-open' : '' }}">
                    <a href="">
                ...
                <li
                    class="{{ Request::is('flash_schedule') || Request::is('flash_schedule') || Request::is('flash_item') ? 'active' : '' }}">
            ...
            @if (Auth::user()->isAdmin())
                <li class="divider"></li>
                <li
                    class="treeview {{ Request::is('settings') || Request::is('homesettings') || Request::is('payment_settings') ? 'active menu-open' : '' }}">
                    <a href="">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li
                            class="{{ Request::is('payment_settings') || Request::is('payment_settings') ? 'active' : '' }}">
