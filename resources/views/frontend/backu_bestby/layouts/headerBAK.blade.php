                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-5">
                        <div class="search-header-w search-header-w_one">
                            <div id="search" class="icon-search hidden-lg hidden-md hidden-sm">
                            ...
                            <div class="so-vertical-menu ">
                                <nav class="navbar-default">
                                    ...
                                    <div class="container-megamenu vertical">
                                        ...
                                        <div class="vertical-wrapper tighten oafnkale">
                                                                    ...
                                                                    <div class="sub-menu" data-subwidth="60"
                                                                        ...
                                                                        <div class="content" style="display: none;">
                                                                            <div class="row">
                                                                                ...
                                                                                {{ get_dynamic_category($term->id, !empty($term->column_count) ? $term->column_count : 5) }}
                        ...
                        <div class="telephone-area">
                            <div class="telephone hidden-xs hidden-sm hidden-md">
                                <ul class="blank">
                                    ...
                                    <li><a href="#"><i class="fa fa-phone-square"></i>Hotline: 01757757235</a></li>
                                </ul>
                            </div>
            ...
            <div class="header-middle header-middle1">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="so-vertical-menu ">
                                    <nav class="navbar-default">
                                        <div class="container-megamenu vertical">
                                            ...
                                            <div class="vertical-wrapper vertical-wrapper_one-ls tighten" id="hide_before_scroll">
                                                <span id="remove-verticalmenu" class="fa fa-times"></span>
                                                <div class="megamenu-pattern">
                                                                ...
                                                                <li class="item-vertical {{ $wsm_cls }}"
                                                                    ...
                                                                    @if($wsm == 1)
                                                                        <div class="sub-menu" data-subwidth="60"
                                                                            ...
                                                                            <div class="content" style="display: none;">
                                                                                <div class="row">
                                                                                    {{ get_dynamic_category($term->id, $term->column_count) }}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                        ...
                        <div class="middle-right middle-right1 nav navbar-nav navbar-right col-lg-3 col-md-3 col-sm-3">
                            @include('frontend.layouts.mini_cart')
                        </div>
