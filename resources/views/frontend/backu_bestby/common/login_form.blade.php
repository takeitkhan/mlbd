<div class="main-container container">
    <ul class="breadcrumb">
        ...
        $breadcrumbs->addCrumb('<i class="fa fa-home"></i>', url('/'))->addCrumb('Register', 'product');
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 new-customer">
                            ...
                            <div class="bottom-form">
                                <a href="{{ url('/create_an_account') }}" class="btn btn-default pull-right">create An
                                    Account</a>
                                <!-- {{ Form::submit('create An Account', ['class' => 'btn btn-default pull-right']) }} -->
                            </div>
                        </div>

                        {{ Form::open(['url' => 'web_login', 'method' => 'post', 'value' => 'PATCH', 'id' => '']) }}
