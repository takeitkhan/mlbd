                                            ...
                                            @if($wsm == 1)
                                                <div class="sub-menu" data-subwidth="60"
                                                    ...
                                                    <div class="content" style="display: none;">
                                                        <div class="row">
                                                            {{ get_dynamic_category($term->id, !empty($term->column_count) ? $term->column_count : 3) }}
                                                            {{--{!! $term->description !!}--}}
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col2">
            <div class="module sohomepage-slider ">
                <div class="yt-content-slider" data-rtl="yes" data-autoplay="yes" data-autoheight="no"
                     data-delay="4" data-speed="0.4" data-margin="0" data-items_column00="1"
            ...
            <div class="module product-simple extra-layout1">
                ...
                <div class="modcontent">
                    <div id="so_extra_slider_1" class="so-extraslider">
                        <div class="yt-content-slider extraslider-inner owl-loaded" data-rtl="yes"
