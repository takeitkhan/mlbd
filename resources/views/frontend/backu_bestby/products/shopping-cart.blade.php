                        ...
                        <div class="table-responsive form-group">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" style="width: 70px !important;">Color</td>
                                    <td class="text-left" style="width: 70px !important;">Size</td>
                                ...
                                @foreach($cartproducts as $product)
                                    <?php
                                     ...
                                     $color_size = App\Pcombinationdata::where(['id' => $product['item']['size_colo']])->get();
                                    //dump($product['item']['item_code']);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if($color_size->count() > 0){
                                                    $color = $color_size->first()->color_codes;
                                                    $c_type = $color_size->first()->type;
                                                    if($c_type != 1){
                                                        echo '<span class="colo-box-front" style="background: #' . $color . '"></span>';
                                                    }else{
                                                        echo '<img src="' . url('public/pmp_img/' . $color) . '" width="30px" height="30px">';
                                            ...
                                            <div class="input-group btn-block quantity">
                                                ...
                                                <span class="input-group-btn">
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       data-toggle="tooltip"
                                                       title="Remove"
                                                       onclick="remove_cart_item('<?php echo $product['item']['productid']; ?>', '<?php echo $product['item']['productcode']; ?>')">
                                        ...
                                        <td class="text-right"
                                            width="160px">{{ $tksign . $product['purchaseprice'] }}
                                            <div>{{ ($product['item']['flash_discount'] != null) ?  '(Flash)' : null }}</div>
                                            <div>{{ ($product['item']['is_dp'] != 'No') ?  '(DP Price)' : null }}</div>
                                        </td>
                                        <td class="text-right"
                                    ...
                                    <div class="cpn">
                                        <div class="col-sm-6 ">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    @if($get_discount)
                                                        {{ Form::submit('Remove', ['id'=> 'remove_coupon', 'class' => 'btn btn-primary', 'name' => 'remove_coupon' ]) }}
...
@section('cusjs')
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            $(document).on('keyup paste change', '#qty_change_checker', function () {
                var value = $(this).val();
