...
<div class="modcontent">
    <div id="so_extra_slider_1" class="so-extraslider">
        <div class="yt-content-slider extraslider-inner" data-rtl="yes" data-pagination="yes"
             data-autoplay="yes" data-delay="4" data-speed="0.6" data-margin="0"
             ...
             data-arrows="no" data-lazyload="yes" data-loop="yes" data-buttonpage="top">
            <div class="item">

                @php
                    $latest_products = \App\Product::where('new_arrival', 'on')->orderBy('id', 'desc')->limit(8)->get()->toArray();
                    //dd($latest_products);
