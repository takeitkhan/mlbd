                ...
                <div class="col-md-6 col-lg-8 col-sm-12 content_one">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="price-btm">
                                                    ...
                                                    <div class="emi-bank-dt-img">
                                                        <ul class="emi-bank-warp owl-carousel owl-theme list-unstyled">
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank6.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank7.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank5.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank1.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank3.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank4.png" alt=""></a></li>
                                                            <li><a href=""><img src="{{ url('/') }}/public/uploads/fullsize/2019-03/bank2.png" alt=""></a></li>
                            ...
                            <!--            <p>Please Call:01757757235</p>-->
                            <!--        </div>-->
                            <!--        <div class="delivery sub-site-title">-->
                            <!--            <h3>Delivery Option</h3>-->
                            <!--            <img src="{{ url('/') }}/public/uploads/fullsize/2019-03/sub-site-img.png" alt="">-->
