...
@section('content')
    ...
    ?>
     <div class="filer-sidenav d-lg-none ">
             <div class="col-md-12 col-lg-none">
                 <div class="mt-3 ">
                    <span class="bar search-filter-" style="font-size:30px;cursor:pointer" onclick="OpenSideBar()"><i class="fa fa-angle-double-right"></i><i class="fa fa-angle-double-right"></i>Search Filter </span>
                 </div>
             </div>
                <div id="MysideName" class="MySideBar">
                    <a href="javascript:void(0)" class="closebtn" onclick="CloseSideBar()"> &times;</a>
                <div class="col-md-12 col-sm-12 responsive_sidebar mt-5">
                    {{ Form::open(array('url' => 'search?cat=' . $category_info->name, 'method' => 'post', 'value' => 'PATCH', 'id' => 'filtering','class' => 'filtering', 'files' => true, 'autocomplete' => 'off')) }}

                    {{ Form::hidden('sort_by', null , ['id' => 'sort_by','class' => 'sort_by']) }}
                    {{ Form::hidden('sort_show', 25 , ['id' => 'sort_show','class' => 'sort_show']) }}

                    <div class="category-sidebar-area "  style="padding: 10px 20px;">
                        ...
                        <div class="sidebar-pneal">
                                ...
                                <div class="card panel sidebar-panel">
                                    <div class="panel-heading sidebar-panel-heading" id="headingOne">
                                        <h4 class="panel-title">
                                            ...
                                            <a data-toggle="collapse" data-target="#xcollapseOne" aria-expanded="true"
                                    ...
                                    <div id="xcollapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="price-range-block">
                                ...
                                <div class="max-pc_wp" style="margin:30px auto">
                                    ...
                                    <div class="max-pc">
                                        <p>Min: </p>
                                        <input type="text" name="price_min" min=0  id="min_price" class="min_price price-range-field" value="{{(isset($url_req->price_min)) ? $url_req->price_min : 0}}" data-min-range="0" />
                                    </div>
                                    <div class="max-pc">
                                        <p>Max: </p>
                                        <input type="text" name="price_max" min=0  id="max_price" class="max_price price-range-field" value="{{(isset($url_req->price_max)) ? $url_req->price_max : 200000}}" data-max-range="200000"/>
                                    </div>

                                    <div class="max-pc">

                                        <a class="btn btn-sm sumbit-price-range" id="sumbit-price-range" href="javascript: void(0)" style="padding:0;color: #fff">Search &nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sidebar-pneal">
                            ...
                            <div class="price-range-block">
                                ...
                                <div class="max-pc_wp" style="margin:30px auto">
                                    ...
                                    <div class="max-pc">
                                        ...
                                        <a class="btn btn-sm sumbit-price-range" id="sumbit-price-range" href="javascript: void(0)">Search &nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-group sidebar-panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            @foreach($filters_att as $filter)
                                    ...
                                    <div class="card panel sidebar-panel">
                                        ...
                                        <div class="panel-heading sidebar-panel-heading" id="headingOne1">
                                            <h4 class="panel-title">
                                                <a href="javascript: void(0)" data-toggle="collapse" data-target="{{'#vcollapse'.$fli_count}}" aria-expanded="true" aria-controls="{{'vcollapse'.$fli_count}}">
                                                    {{ $filter->field_label }}
                                                </a>
                                            </h4>
                                        </div>
                                    ...
                                    @endphp
                                        ...
                                        <div id="{{'vcollapse'.$fli_count}}" class="collapse show" aria-labelledby="{{'collapse'.$fli_count}}"
                                             data-parent="#accordion">
                                            <div class="panel-body sidebar-panel-body">
                                                <div class="sidebar-category-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="min-category-img category-img-padding">
                                ...
                                $catImgFileLink = parse_url($category_info->banner1)['path'];

                                @endphp

                                 <!--/@/if(/file_exists($catImgFileLink)/)/-->
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="sort-by_wp">
                                                <div class="sort-by">
                                                    <select class="form-control item_sort" name="item_sort" id="item_sort">
                                                ...
                                                <div class="page-showe">
                                                    ...
                                                    <div class="showe-select">
                                                        <select class="form-control item_count" id="item_count"  name="item_count">
                        ...
                        @foreach($products as $key => $product)
                            ...
                            @php
                                ...
                                $img = !$img ? url('public/uploads/fullsize/2019-01/default.jpg') : $img;
