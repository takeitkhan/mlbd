        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-3">
                    <div class="home-logo">
                        <a href="{{ url('/') }}">
                            <img src="{{ $setting->com_logourl }}" title="{{ $setting->com_name }}"
                            ...
                            <div class="header-top-bar-wap">
                                <div class="header-top-bar">
                                    <ul class="list-unstyled">
                                        @if (Auth::check())
                                            <li><a href="{{ url('my_account') }}"><span><i
                                                            class="fa fa-user"></i></span> My Account</a></li>
                                            <li><a href="{{ url('logout') }}"><span><i class="fa fa-unlock"></i></span>
                                                    Sign Out</a></li>
                                        @else
                                            <li><a href="{{ url('login_now') }}"><span><i class="fa fa-lock"></i></span>
                                                    Sign In</a></li>
                                        @endif
                                        <li><a href="{{ url('/track_order') }}"><span><i class="fa fa-truck"></i></span>
                                                Track My Order</a></li>
                                    </ul>
                                </div>
                                <div class="hotline">
                                ...
                                <div class="socile">
                                    <ul class="list-unstyled">
                                        <li><a target="_blank"
                                                href="https://www.facebook.com/regalfurniturebangladesh"><i
                                                    class="fa fa-facebook"></i></a></li>
                                        <li><a target="_blank"
                                                href="https://www.youtube.com/channel/UCzHC1qmvTSli0ItjMNreL3A"><i
                ...
                <div class="row">
                                ...
                                @if (isset($parent_items))
                                    @foreach ($parent_items as $parent)
                                        <li>
                                            ...
                                            @endphp
                                            <a class="{{ request()->url() == $parent->link ? 'active' : '' }}"
                                                href="{{ $parent->link }}">{{ $parent->label }}</a>
                                            @if ($sub_menu)
                                                <ul style="">
                                                        ...
                                                        <ul class="megamenu tr_megamenu">
                                                            ...
                                                            @foreach ($categories as $term)
                                                                <li class="item-vertical {{ $term->class }}">
                                                                    <a href="{{ $term->link }}" class="clearfix">
                    ...
                    <div class="col-md-5 col-sm-6 col-xs-5">
                        <div class="header-meu_oarv  header-meu_right text-right">
                            <a href="{{ url('/view_compare') }}"><span><i class="fa fa-balance-scale"></i></span> <span
                                    class="one-top-wpcp" id="show_total_compare"></span> </a>

                            <a href="{{ url('/wishlist') }}"><span><i class="fa fa-heart"></i></span> <span
                                    class="one-top-wpcp" id="show_total_wishlist"></span> </a>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="header-top-bar-wap header-top-bar-wap_one">
                        ...
                        <div class="hotline_back">
                            <div class="hotline">
                                <ul class="list-unstyled">
                                    <li><a href=""><span>Hotline</span> 01757757235</a></li>
                                </ul>
                            </div>
                            <div class="socile socile_top-mb">
                                <ul class="list-unstyled">
                                    <li><a href="https://www.facebook.com/regalfurniturebangladesh"><i
                                                class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCzHC1qmvTSli0ItjMNreL3A"><i
                                                class="fa fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <div class="header-meu text-left moabi_header_list_menu_mb moabi_header_list_menu">
                                <ul class="list-unstyled">
                                    <li><a href="#"><span><i class="fa fa-address-book"></i></span> Voucher</a>
                                    </li>
                                    <li><a href="#"><span><i class="fa fa-certificate"></i></span> Special
                                            Offer</a></li>
                                    <li><a href="{{ url('/wishlist') }}"><span><i
                                                    class="fa fa-file-text-o"></i></span> Wishlist</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="warpper-mb-m">
                            <div class="header_responsive_menu">
                                <div id="mySidenav" class="sidenav">
                                    ...
                                    <div class="home-logo mobail_logo">
                                        <a href="#"><img src="{{ url('public/frontend/images/logo.png') }}"
                                                alt="logo"></a>
                                    </div>
                                    ...
                                    <ul class="mobail_menu_list">
                                        ...
                                        <li>
                                            ...
                                            <a href="#">
                                                Information<span><i class="fa fa-chevron-right"
                            ...
                            <div class="cart-area cart-area_mobile">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="">
                                            Cart <img src="{{ url('public/frontend/images/cart.png') }}"
                                                alt="">
