...
<head>
    ...
    @else
        @php
            if (!empty($pro->title)) {
                ...
                $title = $post->title;
            } elseif (!empty($category_info->description)) {
    ...
    <!--<script>
        (function(w, d, s, l, i) {
            ...
            <
            !--
        })(window, document, 'script', 'dataLayer', 'GTM-NPNS987');
    </script>-->
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            j.src =
                'https://www.googletagmanager.com/gtm.js?id=' + i + dl;
            f.parentNode.insertBefore(j, f);
        })(window, document, 'script', 'dataLayer', 'GTM-TNSXJ44');
    </script>
    <!-- End Google Tag Manager -->
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "WebSite",
  "name": "Master Leather",
  "url": "https://www.masterleatherbd.com",
  "potentialAction": {
    "@type": "SearchAction",
    "target": "http://masterleatherbd.com/main_search_form?product_cat={search_term_string}&keyword=&post_type=product",
...
<body class="common-home res layout-1 hidden-scorll">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TNSXJ44" height="0" width="0"
