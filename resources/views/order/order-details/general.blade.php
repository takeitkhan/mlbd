        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <b>Master Leather BD</b>
                    <small class="pull-right">
                        Royal Tannery, 3rd floor, Hazaribagh, Jigatola, Dhanmondi, Dhaka
                    </small>
                </h2>
            </div>
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    Royal Tannery, 3rd floor, Hazaribagh,<br>
                    Dhaka - 1212, Bangladesh<br>
                    Phone: 01757757235<br>
                    Email: info@masterleatherbd.com
                </address>
            </div>
            ...
            <div class="col-sm-4 invoice-col">
                <a target="_blank"
                   ...
                   href="{{ env('FRONTEND_URL','https://masterleatherbd.com/')}}/order?order_random={{ request()->id }}&order_key={{ $line->secret_key }}">
...
{{--                            </td>--}}
                            ...
                            @endphp
                            <td>
                                <a target="_blank" href="https://masterleatherbd.com/product/{{$get_product_info->seo_url}}">
