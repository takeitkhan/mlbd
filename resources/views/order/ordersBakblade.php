                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                ...
                                                <a target="_blank"
                                                   href="{{env('FRONTEND_URL','https://masterleatherbd.com/')}}/order?order_random={{$line->order_random}}&order_key={{$line->secret_key}}">View
                                                    Invoice</a>
                                            </li>
                                    ...
                                    <div class="btn-group">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a target="_blank"
                                                       href="{{env('FRONTEND_URL','https://masterleatherbd.com/')}}/order?order_random={{$line->order_random}}&order_key={{$line->secret_key}}">
                                                        View Invoice
                                                    </a>
                                                </li>
                                                <li id="move_order">
