...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <link href="{{ URL::asset('public/harimayco/style.css') }}" rel="stylesheet">
            {!! Menu::render() !!}
            ...
            @push('scripts')
                ...
                {{-- {!! Menu::scripts() !!} --}}
                <script type="text/javascript" src="{{ URL::asset('public/harimayco/scripts.js')}}"></script>
                <script type="text/javascript" src="{{ URL::asset('public/harimayco/scripts2.js')}}"></script>
                <script type="text/javascript" src="{{ URL::asset('public/harimayco/menu.js')}}"></script>
            @endpush
        </div>
    </div>
    {{-- {!! Menu::scripts() !!} --}}
