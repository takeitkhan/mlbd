...
{{--                                    </h1>--}}
                                    ...
                                    <p style="text-align: left; font-size:14px; color:#455056; margin:8px 0 0; line-height:24px;">
                                        Thank you for shopping with masterleatherbd.com. <br>
                                                        ...
                                                        @foreach($variations->variations as $vlabel => $vvalue)
                                                            ...
                                                            @if($vvalue && isset($vvalue->value))
                                                                ...
                                                                @if($vvalue->show_as == 'Image')
                                                                    <img src="https://admin.masterleatherbd.com/{{\App\Models\Image::where('id', $vvalue->value)->first()->full_size_directory ?? null}}" alt="" style="width: 30px;">
                                                                @endif
                                                            @endif
                                    ...
                                    <table style="width: 100%; text-align: left; margin-top: 10px;">
                                        ...
                                        <tr>
                                            <td style=""><p style="font-size :  13px; ">
                                                    Need to make changes to your order? Please contact us at <b>+01757757235</b> or via
                                                    <b><a style="text-decoration :  none; " href="mailto:info@masterleatherbd.com" target="_blank">info@masterleatherbd.com</a></b>.
                                                    <br><br>
