...
use App\Http\Controllers\API\ComboOrderController;
...
Route::group(['namespace' => 'API', 'prefix' => 'combo_product'], function () {
    Route::get('/combo-products', [ComboController::class, 'index']);
    Route::get('/combo-products/{id}', [ComboController::class, 'show']);

    // Update the route to use the correct namespace
    Route::get('/prepare-demo-data', [ComboOrderController::class, 'demodata']);
    Route::post('/store-combo-order', [ComboOrderController::class, 'store']);
});
...
Route::group(['namespace' => 'API', 'prefix' => 'product'], function () {
    ...
    Route::any('get-customer-selected-product-variation', [ProductController::class, 'getCustomerSelectProductVariation']);
