...
Route::prefix('sslcommerz')->middleware('cors')->group(function () {
...
Route::middleware(['outlet'])->group(function () {
    Route::get('add_combo_product', [ComboProductController::class, 'add'])->name('add_combo_product');
    Route::post('store_combo_product', [ComboProductController::class, 'store'])->name('store_combo_product');
    Route::get('/combo-product/{id}/edit', [ComboProductController::class, 'edit'])->name('edit_combo_product');
    Route::put('/combo-product/{id}/update', [ComboProductController::class, 'update'])->name('update_combo_product');
    Route::get('combo_list', [ComboProductController::class, 'combo_list'])->name('combo_index');
    Route::get('combo_order_list', [ComboProductController::class, 'combo_order_list'])->name('combo_order_list');
    Route::get('/combo-order/{id}', [ComboProductController::class, 'combo_order_show'])->name('combo_order_show');
