...
class EloquentProduct implements ProductInterface
{
    ...
    {
        return $this->model->where($column, $value)->with('images', 'firstImage')->get();
    }
    ...
    public function getByFilter(array $filter = [], $orderBy = ['id' => 'desc'], $limit = 0)
    {
        ...
        $products = $products->with('firstImage', 'secondImage');
    ...
    public function delete($id)
    {
        ...
        $attributesdata = \App\Models\ProductAttributesData::where('main_id', $id)->delete();
        $product_categories = \App\Models\ProductCategories::where('main_id', $id)->delete();
        $productpricecombination = \App\Models\Productpricecombination::where('main_id', $id)->delete();
        $productimages = \App\Models\ProductImages::where('main_id', $id)->delete();
        $relatedproducts = \App\Models\RelatedProducts::where('main_id', $id)->delete();
...
//        dd($delet_arr);
        ...
        */
        $result = $result->select(
            'products.title', 'products.sub_title', 'products.sku', 'products.seo_url', 'products.local_selling_price', 'products.local_discount', 'products.dp_price',
...
//        $result = $result->select('products.*', 'products.id as proid');
        ...
        $result = $result->with('firstImage', 'secondImage', 'product_set');
...
//           dd($result);
    ...
    {
        return \App\Models\ProductCategories::where('main_pid', $id)->get();
    }

    public function getSimilarProduct($id)
    {
        return \App\Models\RelatedProducts::where('main_pid', $id)->get();
    }

    public function getProductImages($id)
    {
        return \App\Models\ProductImages::where('main_pid', $id)->get();
    }

    public function getProductAttributesData($id)
    {
        return \App\Models\ProductAttributesData::where('main_pid', $id)->get();
    }
    ...
    public function get_search_product_ajax(array $options = array())
    {
        ...
        $result = $result->select('products.*', 't.id as cat_id', 't.seo_url as t_url', 'pv.variation_sub_title', 'pv.variation_product_code'); // nipun
