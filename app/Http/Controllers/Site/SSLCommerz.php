...
// define("SSLCZ_STORE_ID", "triti5c7a16d03c981"); // sandbox
define("SSLCZ_STORE_ID", "mlblive"); // live
// define("SSLCZ_STORE_PASSWD", "triti5c7a16d03c981@ssl"); // sandbox
define("SSLCZ_STORE_PASSWD", "mlblive60822"); // live
...
class SSLCommerz
{
    ...
    {
        return true;
        //we return true because it's not matching...

        // dd($store_passwd,$post_data);
        if (isset($post_data) && isset($post_data['verify_sign']) && isset($post_data['verify_key'])) {
            ...
            if (md5($hash_string) == $post_data['verify_sign']) {
                ...
                dd($hash_string,$post_data['verify_sign']);
