...
class BrandNewBkashController extends Controller
{
    private $base_url;
    private $app_key;
    private $app_secret;
...
//
//$response = $client->request('POST', 'https://checkout.sandbox.bka.sh/v1.2.0-beta/checkout/payment/create', ['body' => '{"amount":"5000","currency":"BDT","intent":"sale","merchantInvoiceNumber":"30902","merchantAssociationInfo":"Master Leather BD"}',
//'headers' => ['Authorization' => 'DSFKLASJDFA2309428',
//'X-APP-Key' => 'DJDN3003',
